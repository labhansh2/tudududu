...
export default function RemoveDeadlineButton() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center gap-2 py-4 px-4 text-sm sm:text-base font-bold rounded-(--border-radius) transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-(--danger) focus:ring-offset-2 focus:ring-offset-(--bg-lightest) relative overflow-hidden"
      style={{

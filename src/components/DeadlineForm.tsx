...
interface DeadlineFormProps {
  defaultValue: string;
  submitDeadline: (formData: FormData) => Promise<{ success: boolean; error?: string }>;
}

export default function DeadlineForm({ defaultValue, submitDeadline }: DeadlineFormProps) {
